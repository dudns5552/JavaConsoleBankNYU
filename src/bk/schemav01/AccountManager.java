...
public class AccountManager {
	...
	// 계좌개설을 위한 함수
		public void makeAccount() {
			...
			System.out.println("계좌번호 : "); String a = scan.nextLine();
			System.out.println("이    름 : "); String n = scan.nextLine();
			System.out.println("잔    고 : "); int b = scan.nextInt();
			scan.nextLine();
		...
		public void depositMoney() {
			...
			System.out.println("계좌번호 : "); String dAcc = scan.nextLine();
			System.out.println("입 금 액 : "); int dpM = scan.nextInt();
			scan.nextLine();
